...
const z=async e=>(await W.get(`artists/${e}/albums`)).data;async function X(){try{return(await W.get("feedbacks",{params:{limit:10,page:1}})).data.data}catch(e){console.log("Error fetching feedbacks",e)}}const x="/nine-friends-of-a-FullStack/assets/sprite-DoBGdM4A.svg";function k(e){document.getElementById(e).classList.remove("hidden")}function g(e){document.getElementById(e).classList.add("hidden")}const G="data:image/webp;base64,";async function _(e){try{const t=await U(e);k("artists__loader");const s=t.artists.map(i=>`
        ...
        </div>`}function ie(){document.querySelectorAll("[data-raty]").forEach(e=>{new I(e,{starOn:V,starOff:Z,score:parseInt(e.dataset.score,10),readOnly:!0}).init()})}function ae(e){if(e<=0)return;const t=0,s=e,i=Math.floor(e/2),r=new P(".mySwiper",{modules:[R,N],pagination:{el:".swiper-pagination",type:"custom",renderCustom:function(a,n,F){let u;return n-1===t?u=t:n===s?u=s:u=i,`
...
function ue(e){Y.error({message:e,position:"topRight",class:"custom-error-toast",timeout:5e3,onOpening:(t,s)=>{const i=s.querySelector(".iziToast-body");if(i){const a=document.createElement("span");a.classList.add("iziToast-icon"),a.innerHTML=`
        ...
        `)}})}const h=c.artistModalElems;//! ============================================================================
async function me(e){Me(),Ee();try{const t=await z(e),{albumsList:s}=t;xe(t);const i=ce(s,!0);be(i),setTimeout(C,0)}catch(t){ue(t.message)}finally{we()}}//! ============================================================================
const Ae=e=>{const{strArtist:t,strArtistThumb:s,intFormedYear:i,intDiedYear:r="",strGender:a,intMembers:n,strCountry:F,strBiographyEN:u,genres:o}=e,m=ne({intFormedYear:i,intDiedYear:r}),A=n&&n>1,M=Le([{title:"Years active",key:"activeYears",value:m},{title:"Sex",key:"strGender",value:a,isBand:A},{title:"Members",key:"intMembers",value:n,isBand:A},{title:"Country",key:"strCountry",value:F},{title:"Biography",key:"strBiographyEN",value:u}]),f=ge(o);return`<section class="about-artist js-about-artist">
            ...
            </section>`};function fe(e){const{key:t,value:s,title:i,isBand:r=""}=e;if(t==="strGender"&&r||t==="intMembers"&&!r)return"";const n=`<li class="${t==="strBiographyEN"?"about-artist__info-item about-artist__info-item--bio":"about-artist__info-item"}">
                           <b class="about-artist__info-item-title">${i}</b>
                           <p class="about-artist__info-item-text">${s}</p>
                        </li>`;return s?n:""}function Le(e){return e.map(fe).join(`
`)}//! ============================================================================
const pe=e=>`<li class="about-artist__music-genre">${e}</li>`;function ge(e){return(e==null?void 0:e.length)>0?e.map(pe).join(`
`):""}//! ============================================================================
const xe=e=>{const t=Ae(e);h.artistModalInnerEl.insertAdjacentHTML("afterbegin",t)};//! ============================================================================
const be=e=>{const t=Fe(e);h.artistModalInnerEl.insertAdjacentHTML("beforeend",t)};function Fe(e){return`<section class="artist-albums js-artist-modal-albums">
            <h2 class="artist-albums__title">Albums</h2>
            <ul class="artist-albums__list js-artist-albums">
              ${ye(e)}
            </ul>
          </section>`}function ye(e){return e.map(Ye).join(`
`)}function Ye(e){const{strAlbum:t="",tracks:s}=e,i=(s==null?void 0:s.length)>0?he(s):"";return`<li class="artist-album">
...
function We(e){const{strTrack:t,intDuration:s,movie:i}=e,r=ve(i),a=le(s);return`<li class="artist-tracks__item">
            <span class="artist-tracks__item-name">${t}</span>
            <span class="artist-tracks__item-duration">${a}</span>
            ${r}
          </li>`}function he(e){return e.map(We).join(`
`)}//! ============================================================================
function ve(e){return de(e)?`<a href="${e}" target="_blank" rel="noopener noreferrer" class="artist-tracks__item-link">
                          <svg class="artist-tracks__item-icon" width="21" height="15">
                            <use href="${x}#icon-Youtube"></use>
                          </svg>
                      </a>`:""}//! ============================================================================
const Ee=()=>{h.artistModalLoaderEl.classList.add("modal-loader-visible")},we=()=>{h.artistModalLoaderEl.classList.remove("modal-loader-visible")},L=c.artistModalElems;let E=0;//! ============================================================================
const ke=e=>{const t=e.target.closest(".js-artist-more-btn");t&&me(t.dataset.artistsId)};//! ============================================================================
function Me(){E=window.scrollY,document.body.style.top=`-${E}px`,document.body.classList.add("scroll-lock"),L.artistModalEl.classList.add("artist-modal--is-open"),document.addEventListener("keydown",O),window.addEventListener("resize",Q),L.artistModalEl.addEventListener("click",$),L.closeArtistModalBtnEl.addEventListener("click",v),L.artistModalBodyEl.scrollTop=0}function v(){L.artistModalEl.classList.remove("artist-modal--is-open"),document.body.classList.remove("scroll-lock"),document.body.style.top="",window.scrollTo(0,E),L.artistModalInnerEl.innerHTML="",document.removeEventListener("keydown",O),window.removeEventListener("resize",Q),L.artistModalEl.removeEventListener("click",$),L.closeArtistModalBtnEl.removeEventListener("click",v)}//! ============================================================================
function O(e){e.key==="Escape"&&v()}//! ============================================================================
function $(e){e.target===L.artistModalEl&&v()}const{artistsList:Be}=c;//! ============================================================================
Be.addEventListener("click",ke);let w=0;c.burgerMenuOpenBtn.addEventListener("click",e=>{_e()});c.burgerMenuCloseBtn.addEventListener("click",e=>{b()});function j(e){if(e.target.classList=="nav-link-modal"){b();const t=document.querySelector(e.target);t&&t.scrollIntoView({behavior:"smooth"})}}function _e(){w=window.scrollY,document.body.style.top=`-${w}px`,document.body.classList.add("scroll-lock"),c.burgerMenu.classList.add("--open"),document.addEventListener("keydown",e=>{e.key==="Escape"&&b()}),c.burgerMenuList.addEventListener("click",e=>{j(e)}),c.burgerMenuCloseBtn.addEventListener("click",e=>{b()})}function b(){c.burgerMenu.classList.remove("--open"),document.removeEventListener("keydown",e=>{e.key==="Escape"&&b()}),c.burgerMenuList.removeEventListener("click",e=>{j(e)}),c.burgerMenuCloseBtn.removeEventListener("click",e=>{b()}),document.body.classList.remove("scroll-lock"),window.scrollTo(0,w)}
