import{a as w,P as z,i as k,R as C,S as X,N as $,b as P}from"./assets/vendor-Bttng-cq.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const c={exampele:document.querySelector(".exampele"),artistsList:document.querySelector(".artists__list"),artistsLoadButton:document.querySelector(".artists__load-btn"),swiperWrapper:document.querySelector(".swiper-wrapper"),swiperBtnPrev:document.querySelector(".swiper-button-prev"),swiperBtnNext:document.querySelector(".swiper-button-next"),artistModalElems:{artistModalEl:document.querySelector(".js-artist-modal"),closeArtistModalBtnEl:document.querySelector("[data-artist-modal-close]"),artistModalInnerEl:document.querySelector(".js-artist-modal-inner"),artistModalBodyEl:document.querySelector(".js-artist-modal-body"),artistModalLoaderEl:document.querySelector(".js-artist-modal-loader")},burgerMenuOpenBtn:document.querySelector(".js-burger-menu-open"),burgerMenuCloseBtn:document.querySelector(".js-burger-menu-close"),burgerMenu:document.querySelector(".burger-overlay"),burgerMenuList:document.querySelector(".mobile-menu-list")};w.defaults.baseURL="https://sound-wave.b.goit.study/api/";async function Y(e=1){try{const{data:t}=await w.get("artists",{params:{limit:8,page:e}});return t}catch(t){throw console.error("Error fetching artists:",t.message),t}}//! ============================================================================
const K=async e=>(await w.get(`artists/${e}/albums`)).data;async function D(){try{return(await w.get("feedbacks",{params:{limit:10,page:1}})).data.data}catch(e){console.log("Error fetching feedbacks",e)}}const E="/seven-friends-of-a-FullStack/assets/sprite-DoBGdM4A.svg";function _(e){document.getElementById(e).classList.remove("hidden")}function b(e){document.getElementById(e).classList.add("hidden")}async function I(e){try{const t=await Y(e);_("artists__loader");const s=t.artists.map(a=>`
        ...
        </div>`}function re(){document.querySelectorAll("[data-raty]").forEach(e=>{new C(e,{starOn:G,starOff:W,score:parseInt(e.dataset.score,10),readOnly:!0}).init()})}function ae(e){if(e<=0)return;const t=0,s=e,a=Math.floor(e/2),r=new X(".mySwiper",{modules:[$,P],pagination:{el:".swiper-pagination",type:"custom",renderCustom:function(n,o,h){let u;return o-1===t?u=t:o===s?u=s:u=a,`
  ...
  `}function r(){const i=e.querySelector("[data-raty]");i&&(i.innerHTML="",new C(i,{starOn:J,starOff:Z,score:0,readOnly:!1,click:function(m){const f=e.querySelector('[data-error="rating"]');f&&(f.textContent="",f.style.display="none");const d=e.querySelector(".form-field-star");d&&d.classList.remove("error")}}).init())}document.addEventListener("click",i=>{if(i.target.closest("[data-feedback-modal-open]")){i.preventDefault(),h();return}if(i.target.closest("[data-feedback-modal-close]")){i.preventDefault(),u();return}if(i.target===e){u();return}}),document.addEventListener("keydown",i=>{i.key==="Escape"&&!e.classList.contains("is-hidden")&&u()});function n(){const i=e.querySelector(".js-feedback-form");i&&(i.removeEventListener("submit",o),i.addEventListener("submit",o))}async function o(i){var R;i.preventDefault(),document.activeElement&&document.activeElement.type==="submit"&&document.activeElement.blur();const m=i.currentTarget,f=new FormData(m),d={name:(f.get("name")||"").trim(),rating:parseInt(((R=e.querySelector('[data-raty] input[name="score"]'))==null?void 0:R.value)||0,10),descr:(f.get("descr")||"").trim()};e.querySelectorAll(".error-message").forEach(l=>{l.textContent="",l.style.display="none"}),e.querySelectorAll(".form-field-name, .form-field-message").forEach(l=>{l.classList.remove("error")}),modals.querySelectorAll(".form-field-name, .form-field-message, .form-field-star").forEach(l=>{l.classList.remove("error")});const p={name:[],descr:[],rating:[]};(d.name.length<2||d.name.length>16)&&p.name.push("The name must be between 2 and 16 characters long"),(d.descr.length<10||d.descr.length>512)&&p.descr.push("The comment must contain between 10 and 512 characters"),d.rating<1&&p.rating.push("");const Q=Object.values(p).some(l=>l.length>0);if(Object.keys(p).forEach(l=>{const g=e.querySelector(`[data-error="${l}"]`);if(g&&p[l].length>0){g.textContent=p[l].join(", "),g.style.display="block";let v;l==="name"?v=g.closest(".form-field-name"):l==="descr"?v=g.closest(".form-field-message"):l==="rating"&&(v=g.closest(".form-field-star")),v&&v.classList.add("error")}}),!Q)try{const l=JSON.parse(localStorage.getItem("feedbacks")||"[]");l.push(d),localStorage.setItem("feedbacks",JSON.stringify(l)),k.success({message:"Review has been added!",position:"bottomCenter",icon:"none",class:"iziToast-center-text"}),u()}catch{k.error({title:"Ошибка",message:"Не удалось сохранить отзыв. Попробуйте еще раз.",class:"iziToast-center-text"})}}function h(){if(!t.querySelector(".js-feedback-form"))t.innerHTML=a();else{e.querySelectorAll(".error-message").forEach(d=>{d.textContent="",d.style.display="none"}),e.querySelectorAll(".form-field-name, .form-field-message, .form-field-star").forEach(d=>{d.classList.remove("error")});const m=e.querySelector(".js-feedback-form");m&&m.reset();const f=e.querySelector("[data-raty]");f&&(f.innerHTML="")}e.classList.remove("is-hidden"),e.setAttribute("aria-hidden","false"),document.body.style.overflow="hidden",s&&(s.style.display="none"),t.style.display="block",r(),n()}function u(){e.querySelectorAll(".error-message").forEach(m=>{m.textContent="",m.style.display="none"}),e.querySelectorAll(".form-field-name, .form-field-message, .form-field-star").forEach(m=>{m.classList.remove("error")}),document.activeElement&&e.contains(document.activeElement)&&document.activeElement.blur(),e.classList.add("is-hidden"),e.setAttribute("aria-hidden","true"),document.body.style.overflow=""}window.__openFeedbackModal=h});let q;//! ============================================================================
const ne=({intFormedYear:e,intDiedYear:t=""})=>{let s="—";const a=Number(e),r=Number(t);return a?t?r>=a&&(s=`${a}-${r}`):s=`${a}-present`:s="information missing",s},oe=()=>window.matchMedia("(min-width: 1440px)").matches?5:window.matchMedia("(min-width: 768px)").matches?4:11,j=()=>{const e=document.querySelector(".about-artist__info-item--bio .about-artist__info-item-text");if(!e)return;e.dataset.fullText||(e.dataset.fullText=e.textContent.trim());const t=e.dataset.fullText;e.style.visibility="hidden";const s=parseFloat(getComputedStyle(e).lineHeight),a=oe(),r=s*a;let n=t.split(" "),o=t;for(e.textContent=o;e.scrollHeight>r&&n.length>0;)n.pop(),o=n.join(" "),e.textContent=o+"...";e.style.maxHeight=`${r}px`,e.style.overflowY=e.scrollHeight>r?"auto":"hidden",e.style.visibility="visible"};function N(){clearTimeout(q),q=setTimeout(j,150)}//! ============================================================================
...
async function ue(e){_e(),Se();try{const t=await K(e),{albumsList:s}=t;be(t);const a=le(s,!0);ye(a),setTimeout(j,0)}catch(t){de(t.message)}finally{Me()}}//! ============================================================================
const me=e=>{const{strArtist:t,strArtistThumb:s,intFormedYear:a,intDiedYear:r="",strGender:n,intMembers:o,strCountry:h,strBiographyEN:u,genres:i}=e,m=ne({intFormedYear:a,intDiedYear:r}),f=o&&o>1,T=pe([{title:"Years active",key:"activeYears",value:m},{title:"Sex",key:"strGender",value:n,isBand:f},{title:"Members",key:"intMembers",value:o,isBand:f},{title:"Country",key:"strCountry",value:h},{title:"Biography",key:"strBiographyEN",value:u}]),p=ge(i);return`<section class="about-artist js-about-artist">
...
const Se=()=>{L.artistModalLoaderEl.classList.add("modal-loader-visible")},Me=()=>{L.artistModalLoaderEl.classList.remove("modal-loader-visible")},A=c.artistModalElems;let M=0;//! ============================================================================
const Be=e=>{const t=e.target.closest(".js-artist-more-btn");t&&ue(t.dataset.artistsId)};//! ============================================================================
function _e(){M=window.scrollY,document.body.style.top=`-${M}px`,document.body.classList.add("scroll-lock"),A.artistModalEl.classList.add("artist-modal--is-open"),document.addEventListener("keydown",O),window.addEventListener("resize",N),A.artistModalEl.addEventListener("click",H),A.closeArtistModalBtnEl.addEventListener("click",S),A.artistModalBodyEl.scrollTop=0}function S(){A.artistModalEl.classList.remove("artist-modal--is-open"),document.body.classList.remove("scroll-lock"),document.body.style.top="",window.scrollTo(0,M),A.artistModalInnerEl.innerHTML="",document.removeEventListener("keydown",O),window.removeEventListener("resize",N),A.artistModalEl.removeEventListener("click",H),A.closeArtistModalBtnEl.removeEventListener("click",S)}//! ============================================================================
function O(e){e.key==="Escape"&&S()}//! ============================================================================
function H(e){e.target===A.artistModalEl&&S()}const{artistsList:Te}=c;//! ============================================================================
Te.addEventListener("click",Be);let B=0;c.burgerMenuOpenBtn.addEventListener("click",e=>{Re()});c.burgerMenuCloseBtn.addEventListener("click",e=>{y()});function U(e){if(e.target.classList=="nav-link-modal"){y();const t=document.querySelector(e.target);t&&t.scrollIntoView({behavior:"smooth"})}}function Re(){B=window.scrollY,document.body.style.top=`-${B}px`,document.body.classList.add("scroll-lock"),c.burgerMenu.classList.add("--open"),document.addEventListener("keydown",e=>{e.key==="Escape"&&y()}),c.burgerMenuList.addEventListener("click",e=>{U(e)}),c.burgerMenuCloseBtn.addEventListener("click",e=>{y()})}function y(){c.burgerMenu.classList.remove("--open"),document.removeEventListener("keydown",e=>{e.key==="Escape"&&y()}),c.burgerMenuList.removeEventListener("click",e=>{U(e)}),c.burgerMenuCloseBtn.removeEventListener("click",e=>{y()}),document.body.classList.remove("scroll-lock"),window.scrollTo(0,B)}
