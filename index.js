...
_e.addEventListener("click",Me);let w=0;l.burgerMenuOpenBtn.addEventListener("click",e=>{Se()});l.burgerMenuCloseBtn.addEventListener("click",e=>{b()});function j(e){if(e.target.classList.contains("nav-link-modal")){b();const t=e.target.getAttribute("href"),s=document.querySelector(t);s&&s.scrollIntoView({behavior:"smooth"})}}function Se(){w=window.scrollY,document.body.style.top=`-${w}px`,document.body.classList.add("scroll-lock"),l.burgerMenu.classList.add("--open"),document.addEventListener("keydown",e=>{e.key==="Escape"&&b()}),l.burgerMenuList.addEventListener("click",e=>{j(e)}),l.burgerMenuCloseBtn.addEventListener("click",e=>{b()})}function b(){l.burgerMenu.classList.remove("--open"),document.removeEventListener("keydown",e=>{e.key==="Escape"&&b()}),l.burgerMenuList.removeEventListener("click",e=>{j(e)}),l.burgerMenuCloseBtn.removeEventListener("click",e=>{b()}),document.body.classList.remove("scroll-lock"),window.scrollTo(0,w)}
