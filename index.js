...
const D=async e=>(await E.get(`artists/${e}/albums`)).data;async function F(){try{return(await E.get("feedbacks",{params:{limit:10,page:1}})).data.data}catch(e){console.log("Error fetching feedbacks",e)}}const y="/nine-friends-of-a-FullStack/assets/sprite-DoBGdM4A.svg";function _(e){document.getElementById(e).classList.remove("hidden")}function b(e){document.getElementById(e).classList.add("hidden")}async function R(e){try{const t=await K(e);_("artists__loader");const s=t.artists.map(a=>`
        ...
        </div>`}function re(){document.querySelectorAll("[data-raty]").forEach(e=>{new j(e,{starOn:G,starOff:W,score:parseInt(e.dataset.score,10),readOnly:!0}).init()})}function ae(e){if(e<=0)return;const t=0,s=e,a=Math.floor(e/2),r=new X(".mySwiper",{modules:[P,Y],pagination:{el:".swiper-pagination",type:"custom",renderCustom:function(n,i,v){let u;return i-1===t?u=t:i===s?u=s:u=a,`
...
function we(e){const{strTrack:t,intDuration:s,movie:a}=e,r=Le(a),n=oe(s);return`<li class="artist-tracks__item">
