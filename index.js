...
async function U(e){W.post("feedbacks",{...e})}const x="/nine-friends-of-a-FullStack/assets/sprite-DoBGdM4A.svg";function w(e){document.getElementById(e).classList.remove("hidden")}function g(e){document.getElementById(e).classList.add("hidden")}const X="data:image/webp;base64,";async function _(e){try{const t=await R(e);w("artists__loader");const s=t.artists.map(i=>`
        ...
        </div>`}function se(){document.querySelectorAll("[data-raty]").forEach(e=>{new q(e,{starOn:G,starOff:V,score:parseInt(e.dataset.score,10),readOnly:!0}).init()})}function re(e){if(e<=0)return;const t=0,s=e,i=Math.floor(e/2),r=new D(".mySwiper",{modules:[j,P],pagination:{el:".swiper-pagination",type:"custom",renderCustom:function(a,o,F){let u;return o-1===t?u=t:o===s?u=s:u=i,`
...
ke.addEventListener("click",ve);let k=0;l.burgerMenuOpenBtn.addEventListener("click",e=>{we()});l.burgerMenuCloseBtn.addEventListener("click",e=>{b()});function O(e){if(e.target.classList.contains("nav-link-modal")){b();const t=e.target.getAttribute("href"),s=document.querySelector(t);s&&s.scrollIntoView({behavior:"smooth"})}}function we(){k=window.scrollY,document.body.style.top=`-${k}px`,document.body.classList.add("scroll-lock"),l.burgerMenu.classList.add("open"),document.addEventListener("keydown",e=>{e.key==="Escape"&&b()}),l.burgerMenuList.addEventListener("click",e=>{O(e)}),l.burgerMenuCloseBtn.addEventListener("click",e=>{b()})}function b(){l.burgerMenu.classList.remove("open"),document.removeEventListener("keydown",e=>{e.key==="Escape"&&b()}),l.burgerMenuList.removeEventListener("click",e=>{O(e)}),l.burgerMenuCloseBtn.removeEventListener("click",e=>{b()}),document.body.classList.remove("scroll-lock"),window.scrollTo(0,k)}
