...
async function z(e){y.post("feedbacks",{...e})}const x="/nine-friends-of-a-FullStack/assets/sprite-DoBGdM4A.svg",X="data:image/webp;base64,",q=8;function V(e=q){return new Array(e).fill(0).map(()=>`
        ...
        `).join("")}async function _(e){try{l.artistsList.innerHTML=V(q);const t=await U(e),s=t.artists.map(r=>`
        ...
        `).join("");return l.artistsList.innerHTML=s,t}catch(t){throw console.error("Error in createArtistsList:",t),l.artistsList.innerHTML="",t}}const B=document.getElementById("pagination");let S=null;async function G(){const e=await _(1);S=new $(B,{totalItems:e.totalArtists,itemsPerPage:e.limit,visiblePages:5,centerAlign:!0,template:{page:'<a href="#" class="custom-page-btn">{{page}}</a>',currentPage:'<strong class="custom-current">{{page}}</strong>',moveButton:'<a href="#" class="custom-move-btn tui-{{type}}" aria-label="move button"><span class="icon-{{type}}"></span></a>',disabledMoveButton:'<span class="custom-move-btn disabled tui-{{type}}"><span class="icon-{{type}}"></span></span>',moreButton:'<a href="#" class="custom-ellip">...</a>'}});const t={first:'<svg width="24" height="24" viewBox="0 0 24 24" fill="#fff"><path d="M18 6v12l-8-6 8-6zM6 6h2v12H6V6z"/></svg>',prev:`<svg class="artists__pagination-icon"><use href="${x}#icon-left-arrow"></use></svg>`,next:`<svg class="artists__pagination-icon"><use href="${x}#icon-right-arrow"></use></svg>`,last:'<svg width="24" height="24" viewBox="0 0 24 24" fill="#fff"><path d="M6 6v12l8-6-8-6zM18 6h-2v12h2V6z"/></svg>'};function s(){["first","prev","next","last"].forEach(r=>{const i=B.querySelector(`.tui-${r} .icon-${r}`);i&&(i.innerHTML=t[r])})}s(),S.on("afterMove",async r=>{const i=r.page;await _(i),s();const a=l.artistsList.getBoundingClientRect().top+window.scrollY-100;window.scrollTo({top:a,behavior:"smooth"})})}G();const J="data:image/webp;base64,",Z="data:image/webp;base64,",K="data:image/webp;base64,",ee="data:image/webp;base64,";function te(e){document.getElementById(e).classList.remove("hidden")}function W(e){document.getElementById(e).classList.add("hidden")}async function se(){let e=[];try{te("feedbacks-loader");try{const t=await N();t&&Array.isArray(t)&&(e=t)}catch{console.log("API not available, trying localStorage");const s=localStorage.getItem("feedbacks");s&&(e=JSON.parse(s))}if(e.length===0){W("feedbacks-loader"),l.swiperWrapper.innerHTML="<p>Ще немає відгуків. Будьте першим!</p>";return}re(e),ne(e.length),ae()}catch{W("feedbacks-loader"),h.error({message:"Помилка завантаження відгуків"});return}W("feedbacks-loader")}se();function re(e){const t=e.map(ie).join("");l.swiperWrapper.innerHTML=t}function ie({name:e,descr:t,rating:s}){return`<div class="swiper-slide">
        ...
        </div>`}function ae(){document.querySelectorAll("[data-raty]").forEach(e=>{new I(e,{starOn:J,starOff:Z,score:parseInt(e.dataset.score,10),readOnly:!0}).init()})}function ne(e){if(e<=0)return;const t=0,s=e,r=Math.floor(e/2),i=new H(".mySwiper",{modules:[j,P],pagination:{el:".swiper-pagination",type:"custom",renderCustom:function(a,o,f){let c;return o-1===t?c=t:o===s?c=s:c=r,`
...
function ue(e){h.error({message:e,position:"topRight",class:"custom-error-toast",timeout:5e3,onOpening:(t,s)=>{const r=s.querySelector(".iziToast-body");if(r){const a=document.createElement("span");a.classList.add("iziToast-icon"),a.innerHTML=`
...
async function me(e){we(),ve(),g.artistModalInnerEl.innerHTML="";try{const t=await R(e),{albumsList:s}=t;be(t);const r=ce(s,!0);await Fe(r)}catch(t){ue((t==null?void 0:t.message)||"Failed to load artist data")}finally{Ee()}}//! ============================================================================
const Ae=e=>{const{strArtist:t,strArtistThumb:s,intFormedYear:r,intDiedYear:i="",strGender:a,intMembers:o,strCountry:f,strBiographyEN:c,genres:n}=e,u=oe({intFormedYear:r,intDiedYear:i}),A=o&&o>1,w=Le([{title:"Years active",key:"activeYears",value:u},{title:"Sex",key:"strGender",value:a,isBand:A},{title:"Members",key:"intMembers",value:o,isBand:A},{title:"Country",key:"strCountry",value:f},{title:"Biography",key:"strBiographyEN",value:c}]),L=ge(n);return`<section class="about-artist js-about-artist" aria-labelledby="about-artist-title">
            ...
            </section>`};function fe(e){const{key:t,value:s,title:r,isBand:i=""}=e;if(t==="strGender"&&i||t==="intMembers"&&!i)return"";const o=`<li class="${t==="strBiographyEN"?"about-artist__info-item about-artist__info-item--bio":"about-artist__info-item"}">
                           <b class="about-artist__info-item-title">${r}</b>
                           <p class="about-artist__info-item-text">${s}</p>
                        </li>`;return s?o:""}function Le(e){return e.map(fe).join(`
`)}//! ============================================================================
const pe=e=>`<li class="about-artist__music-genre">${e}</li>`;function ge(e){return(e==null?void 0:e.map(pe).join(""))||""}//! ============================================================================
const be=e=>{const t=Ae(e);g.artistModalInnerEl.insertAdjacentHTML("afterbegin",t);const s=g.artistModalInnerEl.querySelector(".about-artist__image");s.addEventListener("error",()=>{s.dataset.errorHandled||(s.src="img/default-artist.png",s.dataset.errorHandled="true")})};//! ============================================================================
function T(e,t,s){const a=s.current,o=e.slice(a,a+5),f=document.createDocumentFragment();return o.forEach(c=>{const n=document.createElement("li");n.classList.add("artist-album"),n.innerHTML=Ye(c),f.appendChild(n)}),t.appendChild(f),requestAnimationFrame(()=>{o.forEach((c,n)=>{const u=t.children[a+n];u&&setTimeout(()=>{u.classList.add("artist-album--visible")},n*100)})}),s.current+=5,t.lastElementChild}function xe(e,t,s){if(!(e!=null&&e.length)||!t)return;const r=new IntersectionObserver(a=>{a.forEach(o=>{if(o.isIntersecting){r.unobserve(o.target);const f=T(e,t,s);s.current<e.length&&f&&r.observe(f)}})},{root:null,rootMargin:"0px",threshold:.5}),i=T(e,t,s);i&&s.current<e.length&&r.observe(i)}const Fe=async e=>{const s=`<section class="artist-albums js-artist-modal-albums">
                  ...
                  </section>`;g.artistModalInnerEl.insertAdjacentHTML("beforeend",s);const r=g.artistModalInnerEl.querySelector(".js-artist-albums");if(!r)return;xe(e,r,{current:0})};function Ye(e){const{strAlbum:t="",tracks:s}=e,r=(s==null?void 0:s.length)>0?We(s):"";return`<h3 class="artist-album__title">${t}</h3>
          ...
          `}//! ============================================================================
function ye(e){const{strTrack:t,intDuration:s,movie:r}=e,i=he(r,t),a=le(s);return`<li class="artist-tracks__item">
            <span class="artist-tracks__item-name">${t}</span>
            <span class="artist-tracks__item-duration">${a}</span>
            ${i}
          </li>`}function We(e){return e.map(ye).join(`
`)}//! ============================================================================
function he(e,t){return de(e)?`<a href="${e}" target="_blank" rel="noopener noreferrer" 
...
const ve=()=>{g.artistModalLoaderEl.classList.add("modal-loader-visible")},Ee=()=>{g.artistModalLoaderEl.classList.remove("modal-loader-visible")},p=l.artistModalElems;let E=0;//! ============================================================================
const ke=e=>{const t=e.target.closest(".js-artist-more-btn");t&&me(t.dataset.artistsId)};//! ============================================================================
function we(){E=window.scrollY,document.body.style.top=`-${E}px`,document.body.classList.add("scroll-lock"),p.artistModalEl.classList.add("artist-modal--is-open"),document.addEventListener("keydown",C),p.artistModalEl.addEventListener("click",Q),p.closeArtistModalBtnEl.addEventListener("click",v),p.artistModalBodyEl.scrollTop=0}function v(){p.artistModalEl.classList.remove("artist-modal--is-open"),document.body.classList.remove("scroll-lock"),document.body.style.top="",window.scrollTo(0,E),p.artistModalInnerEl.innerHTML="",document.removeEventListener("keydown",C),p.artistModalEl.removeEventListener("click",Q),p.closeArtistModalBtnEl.removeEventListener("click",v)}//! ============================================================================
function C(e){e.key==="Escape"&&v()}//! ============================================================================
function Q(e){e.target===p.artistModalEl&&v()}const{artistsList:Me}=l;//! ============================================================================
Me.addEventListener("click",ke);let k=0;l.burgerMenuOpenBtn.addEventListener("click",e=>{_e()});l.burgerMenuCloseBtn.addEventListener("click",e=>{F()});function D(e){if(e.target.classList.contains("nav-link-modal")){F();const t=e.target.getAttribute("href"),s=document.querySelector(t);s&&s.scrollIntoView({behavior:"smooth"})}}function _e(){k=window.scrollY,document.body.style.top=`-${k}px`,document.body.classList.add("scroll-lock"),l.burgerMenu.classList.add("open"),document.addEventListener("keydown",e=>{e.key==="Escape"&&F()}),l.burgerMenuList.addEventListener("click",e=>{D(e)}),l.burgerMenuCloseBtn.addEventListener("click",e=>{F()})}function F(){l.burgerMenu.classList.remove("open"),document.removeEventListener("keydown",e=>{e.key==="Escape"&&F()}),l.burgerMenuList.removeEventListener("click",e=>{D(e)}),l.burgerMenuCloseBtn.removeEventListener("click",e=>{F()}),document.body.classList.remove("scroll-lock"),window.scrollTo(0,k)}
